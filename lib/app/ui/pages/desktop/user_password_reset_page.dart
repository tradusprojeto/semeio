...
class UserPasswordResetPage extends GetView<UserPasswordResetController> {
          ...
          return Center(
            child: Stack(
              ...
              children: [
                ...
                _buildFormSendPasswordLink(formWidth, formHeight, baseFontSize),
              ],
            ),
          );
        },
  ...
  Widget _buildFormSendPasswordLink(
            ...
            child: Column(
              children: [
                Column(
                  ...
                  children: [
                    Text(
                        "Um link de recuperação será enviado para o endereço de e-mail abaixo",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                  ...
                  () => SizedBox(
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: controller.isLoading.value
                          ? null
                          : controller.sendPasswordResetLinkForEmail,
                      child: Center(
